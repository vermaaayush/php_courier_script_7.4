		...
		<main>
			<table width="50%" border="1">
				...
				<?php
					...
					$sql=dbQuery("SELECT cid,tracking,pick_time,book_date,ship_name,rev_name,r_phone,status FROM courier WHERE book_mode = 'Credit_card'  AND officename='".$_SESSION["user_type"]."' AND book_date   BETWEEN '$desde' AND '$hasta'");
