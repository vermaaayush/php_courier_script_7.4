			...
			<div class="card-box table-responsive">
				...
				<table border="0" align="center">
				   ...
				   <table ui-jq="dataTable" ui-options="" class="table table-striped b-t b-b">			  
					...
					<tbody>
					<?php  					
						$result3 = dbQuery("SELECT * FROM courier WHERE book_mode = 'Credit_card'  ORDER BY cid");
					...
					<tbody>
					<?php  					
						$result3 = dbQuery("SELECT * FROM courier WHERE book_mode = 'Credit_card' and officename='".$_SESSION["user_type"]."' ORDER BY cid");
						while($row = dbFetchArray($result3)) {					
					?> 
					  <tr>							  
								  <td align="center">
