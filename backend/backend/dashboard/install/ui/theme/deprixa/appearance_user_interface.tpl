            ...
            <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <select name="contact_set_view_mode" id="contact_set_view_mode" class="form-control">
                        ...
                        <option value="tbl" {if $_c['contact_set_view_mode'] eq 'tbl'}selected{/if}>{$_L['Table']}</option>
                        <option value="card" {if $_c['contact_set_view_mode'] eq 'card'}selected{/if}>{$_L['Card']}</option>
                        <option value="search" {if $_c['contact_set_view_mode'] eq 'search'}selected{/if}>{$_L['Search']}</option>
