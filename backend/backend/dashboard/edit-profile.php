...
$cid=$_GET['cid'];
$resultado = $con->query("SELECT cid,name_parson,name,email,phone,office,role,pwd,date,imagen,tipo_imagen FROM manager_admin WHERE cid='$cid' ");
isUser();													 
?>
<!DOCTYPE html>
<html lang="en">
						...
						<tr>				
							<h3 class="classic-title"><span><strong><i class="fa fa-users icon text-default-lter"></i>&nbsp;&nbsp;<?php echo $PERFIL; ?></strong></h3>
								...
								<?php while($row = $resultado->fetch_assoc()){ ?> 
									<form action="settings/addusersadmin/update.php"  name="modificar_usuario" method="POST" enctype="multipart/form-data" > 
									<div class="row">
